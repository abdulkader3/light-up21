      ...
      <div className="container flex justify-center mt-[100px]  ">
        <div className=" w-[1300px] h-full bg-white rounded-[20px] flex flex-col ">
          ...
          <div className=" mt-[100px] w-full h-full flex justify-center">
            <div className="w-[1150px] h-[322px] bg-[#f8fbfb] rounded-2xl flex  flex-col items-center justify-center ">
              <div className="  ">
              ...
              <div className="p-10 w-full flex justify-between">
                <img
                  ...
                  src="photos/slide1.png"
                  alt="slide image"
                />
                <img
                  className=" w-[80px] h-[70px] "
                  src="photos/slide2.png"
                  alt="slide image"
                />
                <img
                  className=" w-[80px] h-[70px] "
                  src="photos/slide3.png"
                  alt="slide image"
                />
                <img
                  className=" w-[140px] h-[70px] "
                  src="photos/slide4.png"
                  alt="slide image"
                />
                <img
                  className=" w-[100px] h-[70px] "
          ...
          <div className=" w-full h-full flex justify-center mt-10 mb-10 ">
            <p className=" text-[16px] font-poppins font-normal text-[#44566c] ">
